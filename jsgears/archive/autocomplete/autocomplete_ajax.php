...
$query_Recordset1 = "SELECT * FROM namedata WHERE sName LIKE '$q%' ORDER BY sName ASC";
//file_put_contents('test.log.txt', $query_Recordset1."\n", FILE_APPEND);
...
do
{
echo $row_Recordset1['sName']."\n";
//echo iconv("big5","UTF-8",$row_Recordset1['sName']."\n");
}
