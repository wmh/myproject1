...
function fGet($fp, $host, $port, $path, $extra = '') {
        $getContent = "GET $path HTTP/1.1\r\n";
        $getContent .= "Connection: upgrade\r\n";
        $getContent .= "Host: $host\r\n";
        $getContent .= "Origin: http://$host:$port\r\n";
        $getContent .= "Sec-WebSocket-Key: OD0S7H2SYJAqYntLuu+Cvw==\r\n";
        $getContent .= "Sec-WebSocket-Version: 13\r\n";
        if ($extra != "") $getContent .= "$extra\r\n";
        fputs($fp, $getContent."\r\n");
}
